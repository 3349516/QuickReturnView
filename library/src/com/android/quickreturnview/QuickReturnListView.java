...
public class QuickReturnListView extends ListView {
    ...
    public View quickReturnView;
	    ...
	    public QuickReturnMultiColumnListView(Context context, AttributeSet attrs) {
	        super(context, attrs);
	    }

	    public QuickReturnMultiColumnListView(Context context, AttributeSet attrs, int defStyle) {
	    ...
	    protected void onFinishInflate() {
	        ...
	        super.setOnScrollListener(new OnScrollListener() {
	            @Override
	            public void onScrollStateChanged(PLA_AbsListView absListView, int i) {
	                if (listener != null) {
	            ...
	            @Override
	            public void onScroll(PLA_AbsListView absListView, int i, int i2, int i3) {
	                if (listener != null) {
	                ...
	                if (isScrollUp && !isOnScreen && !noAnimation) {
	                    noAnimation = true;
	                    if(QuickReturnViewType.TOP==returnViewType){
